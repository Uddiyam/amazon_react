            ...
            <div className={styles.item_container}>
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>10</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarHalfFill/> </p>
                    </p>
                ...
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>20</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarFill/> </p>
                    </p>
                ...
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>98.99</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarHalfFill/> <RiStarLine/> </p>
                    </p>
                ...
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>199.99</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarLine/> <RiStarLine/> </p>
                    </p>
                ...
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>98.99</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarLine/> <RiStarLine/> <RiStarLine/> </p>
                    </p>
                ...
                <div className={styles.item_row}>
                    ...
                    <p className={styles.item_price}>
                        <small>$.</small>
                        <b>598.99</b>
                        <p className={styles.item_rating}> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarFill/> <RiStarLine/> </p>
                    </p>
