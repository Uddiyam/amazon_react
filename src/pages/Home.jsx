    ...
    <div className={styles.Home_background}>
      <div className={styles.home_image_container}>
        <div className={styles.home_image}>
          <img
            src={process.env.PUBLIC_URL + "/image/image" + [img_num] + ".jpg"}
          />
        </div>
      </div>
      ...
      <div className={styles.item_container}>
        ...
        <div className={styles.item_row}>
          ...
          <span>
            Apple Watch Series 3 (GPS, 42mm) - Space Grey Aluminium Case with
            Black Sport Band
          </span>
        ...
        <div className={styles.item_row}>
          ...
          <p className={styles.item_price}>
            ...
            <b>98.99</b>
            <p className={styles.item_rating}>
              <RiStarFill /> <RiStarFill /> <RiStarFill /> <RiStarHalfFill />{" "}
              <RiStarLine />{" "}
            </p>
          </p>
        ...
        <div className={styles.item_row}>
          ...
          <p className={styles.item_price}>
            ...
            <p className={styles.item_rating}>
              {" "}
              <RiStarFill /> <RiStarFill /> <RiStarFill /> <RiStarLine />{" "}
              <RiStarLine />{" "}
            </p>
          </p>
        ...
        <div className={styles.item_row}>
          ...
          <p className={styles.item_price}>
            ...
            <p className={styles.item_rating}>
              {" "}
              <RiStarFill /> <RiStarFill /> <RiStarLine /> <RiStarLine />{" "}
              <RiStarLine />{" "}
            </p>
          </p>
