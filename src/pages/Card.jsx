...
function Card(props) {
  ...
  let halfRating =
    (props.products.grade - Math.floor(props.products.grade)) * 10;
  let outline = 0;

  halfRating > 0
    ? (outline = 5 - Math.ceil(props.products.grade))
    : (outline = 5 - Math.floor(props.products.grade));
    ...
    <div className={styles.box}>
      ...
      <div className={styles.item_rating}>
        ...
        {outline > 0
          ? Array(outline)
              .fill()
              .map((_, index) => <RiStarLine key={index} />)
          : ""}
      </div>
